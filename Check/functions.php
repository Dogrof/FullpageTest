...
function coelix_scripts() {
	...
	wp_enqueue_style( 'coelix-playfair', 'https://fonts.googleapis.com/css2?family=Playfair+Display:wght@400;500;600;700&display=swap' );
	 wp_enqueue_style( 'coelix-montserrat', 'https://fonts.googleapis.com/css2?family=Montserrat:wght@300;400;500;600&display=swap' );
    ...
    wp_enqueue_style( 'coelix-dogrof-style', get_template_directory_uri() . '/assets/css/main.css' );
	//wp_enqueue_style( 'coelix-main-style', get_template_directory_uri() . '/dist/main.css' );
	wp_enqueue_script( 'coelix-main-script', get_template_directory_uri() . '/assets/js/main.js', array(), false, true );
